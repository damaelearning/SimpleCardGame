...
def evaluate_best_player(batch, count, total_point):
    ...
    next_actions = (async_ismcts_action, ismcts_action)
    evaluate_algorithm_of('async win rate', next_actions, batch, count, total_point)
...
def multi_process_evaluate_best_player(process_num):
    ...
    print('async win rate', average_point)
